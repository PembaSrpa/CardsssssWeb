...
export default function GlossarB2FlashcardsPage(): React.JSX.Element {
  ...
  useEffect(() => {
    Storage.setItem(glossarListIndexKey("B2", kapitel, moduleId), String(index));
    Storage.setItem(UI_STORAGE_KEYS.LAST_GLOSSAR_LEVEL, "B2");
    Storage.setItem(UI_STORAGE_KEYS.LAST_GLOSSAR_KAPITEL, String(kapitel));
    Storage.setItem(UI_STORAGE_KEYS.LAST_GLOSSAR_MODULE, moduleId);
